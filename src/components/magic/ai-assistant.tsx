...
export function AiAssistant() {
  ...
  const [messages, setMessages] = useState<{ role: "user" | "assistant"; text: string }[]>([
    { role: "assistant", text: "Hi! I'm the A Sports Zone assistant. Ask me to find cricket gear, bats, shoes, or combos — where the trust builds!" },
  ]);
          ...
          >
            <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3">
              <span className="flex items-center gap-2 font-medium">
                <Sparkles className="h-4 w-4 text-[var(--accent)]" /> A Sports Zone AI
              </span>
            ...
            <div className="flex items-center gap-2 border-t border-[var(--border)] p-3">
              <input
                ...
                placeholder="Ask A Sports Zone AI…"
